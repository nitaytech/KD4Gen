...
def train_kd(output_dir: str,
    ...
    dataloaders = prepare_dataloaders(tokenizer, datasets, max_input_length, max_labels_length, model_type,
                                      ...
                                      shuffle_train=True, include_id_col=False, include_logits=True,
    ...
    accelerator, student, optimizer, lr_scheduler, dataloaders = prepare_accelerator(
        student, None, dataloaders, gradient_accumulation_steps,
    ...
    for epoch in range(starting_epoch, train_epochs):
        ...
        for step, batch in enumerate(progress_bar):
            ...
            teacher_outputs = {'logits': batch['logits']} if 'logits' in batch else {}
            loss = loss_step(student, teacher_outputs, input_ids, attention_mask, labels,
            ...
            if do_evaluation(step, len(progress_bar), save_checkpoint_every_n_steps):
                ...
                loss_scheduler.change_stage(epoch, new_score, accelerator, student, None,
    ...
    del accelerator, student, optimizer, lr_scheduler
    gc.collect()
